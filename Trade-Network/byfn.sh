...
function upgradeNetwork() {
  ...
  for PEER in peer0.exporterorg.trade.com peer1.exporterorg.trade.com peer0.importerorg.trade.com peer1.importerorg.trade.com peer0.exportingentityorg.trade.com; do
...
function networkDown() {
  # stop org3 containers also in addition to exporterorg, importerorg, exportingentityorg, in case we were running sample to add org3
